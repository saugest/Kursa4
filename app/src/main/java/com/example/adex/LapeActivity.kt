...
class LapeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bt.setOnClickListener{
            bt.setBackgroundColor(Color.parseColor("#44944a"))
            bvk.setBackgroundColor(Color.parseColor("#dbd27a"))
        ...
        bvk.setOnClickListener{
            bvk.setBackgroundColor(Color.parseColor("#44944a"))
            bt.setBackgroundColor(Color.parseColor("#dbd27a"))
            CoroutineScope(Dispatchers.IO).launch {
